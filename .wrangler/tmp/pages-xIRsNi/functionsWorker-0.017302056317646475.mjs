...
async function counts(db) {
  const q = /* @__PURE__ */ __name(async (sql) => Number((await db.prepare(sql).first())?.n ?? 0), "q");
  return {
...
// ../.wrangler/tmp/pages-xIRsNi/functionsRoutes-0.9778966725730116.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-lOX8Fh/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-lOX8Fh/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.017302056317646475.mjs.map
